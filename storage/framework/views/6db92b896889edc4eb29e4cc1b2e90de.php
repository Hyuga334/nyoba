                    ...
                    <li class="header-right-item">
                        <div class="dropdown notifications language">
                            <button class="btn btn-secondary border-0 p-0 position-relative" type="button"
                                ...
                                <img src="<?php echo e(asset('farol')); ?>/assets/images/united-states.jpg"
                            ...
                            <div class="dropdown-menu dropdown-lg p-0 border-0 p-4">
                                ...
                                <div class="notification-menu">
                                    <a href="notification.html" class="dropdown-item p-0">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(asset('farol')); ?>/assets/images/spain.png"
                                ...
                                <div class="notification-menu mb-0">
                                    <a href="notification.html" class="dropdown-item p-0">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(asset('farol')); ?>/assets/images/germany.png"
                            ...
                            <div class="dropdown-menu dropdown-lg p-0 border-0 p-4">
                                ...
                                <div class="notification-menu">
                                    <a href="notification.html" class="dropdown-item p-0">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(asset('farol')); ?>/assets/images/pdf.svg" alt="pdf">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="notification-menu">
                                    <a href="notification.html" class="dropdown-item p-0">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(asset('farol')); ?>/assets/images/notifications-1.jpg"
                                                    alt="notifications">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <div class="notification-menu mb-0">
                                    <a href="notification.html" class="dropdown-item p-0">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(asset('farol')); ?>/assets/images/notifications-2.jpg"
                                                    alt="notifications">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-xxl-flex align-items-center bg-transparent border-0 text-start p-0 cursor"
                                ...
                                <div class="flex-shrink-0">
                                    <img class="rounded-circle wh-54"
                                        src="<?php echo e(asset('farol')); ?>/assets/images/admin.jpg" alt="admin">
                                </div>
                                <div class="flex-grow-1 ms-3">
...
<?php /**PATH C:\laragon\www\seleksi_karyawan_baru\penerimaan_karawan_baru\resources\views/admin/components/header.blade.php ENDPATH**/ ?>